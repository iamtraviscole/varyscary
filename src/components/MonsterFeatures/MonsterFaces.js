...
export const Face1 = (props) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='-144.288 -133.593 375 375'>
      <circle id='MonsterFaces__face-1' fill={props.fillColor} cx='43.213' cy='43.212' r='43.213' />
    </svg>
  )
}
...
export const Face2 = (props) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='-145.329 -143.444 375 375'>
      <path id='MonsterFaces__face-2' fill={props.fillColor}
...
export const Face3 = (props) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='-144 -141.976 375 375'>
      <path id='MonsterFaces__face-3' fill={props.fillColor}
...
export const Face4 = (props) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='-144 -140.893 375 375'>
      <path id='MonsterFaces__face-4' fill={props.fillColor}
...
export const Face5 = (props) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='-144 -143.207 375 375'>
      <path id='MonsterFaces__face-5' fill={props.fillColor}
...
export const Face6 = (props) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='-144 -143.778 375 375'>
      <path id='MonsterFaces__face-6' fill={props.fillColor}
